...
export default async function Page(){
 ...
 const [customers,messages,templates]=await Promise.all([
  ...
  rest<any[]>(`messenger_messages?select=id,customer_id,psid,direction,message_type,body,status,read_at,created_at&message_type=neq.referral&order=created_at.desc&limit=500`,{},true),
